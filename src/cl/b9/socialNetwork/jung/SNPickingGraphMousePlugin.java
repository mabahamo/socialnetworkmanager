 ...
 * @author Tom Nelson
 */
public class SNPickingGraphMousePlugin<V, E> extends AbstractGraphMousePlugin
	 ...
	 */
	public SNPickingGraphMousePlugin() {
	 ...
	 */
    public SNPickingGraphMousePlugin(int selectionModifiers, int addToSelectionModifiers) {
     ...
     *
     */
    protected void pickContainedVertices(VisualizationViewer<SNNode,SNEdge> vv, Point2D down, Point2D out, boolean clear) {
        
        Layout<SNNode,SNEdge> layout = vv.getGraphLayout();
        PickedState<SNNode> pickedVertexState = vv.getPickedVertexState();
        ...
        if(pickedVertexState != null) {
            ...
            Collection<SNNode> picked = pickSupport.getVertices(layout, pickRectangle);
            for(SNNode v : picked) {
